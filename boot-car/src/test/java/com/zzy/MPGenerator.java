...
public class MPGenerator {
    ...
    public void generate() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/et2209?serverTimezone=UTC");
        ...
        strategy.setLikeTable(new LikeTable("t_", SqlLike.RIGHT)); // "t_%"
